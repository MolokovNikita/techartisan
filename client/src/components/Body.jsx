                ...
                <div className={styles.topic}>
                    <div className={styles.topic_arrow}>
                        <ol className={styles.arrow_list}>
                            ...
                            <li className={styles.second_arrow}><img src="/arrow.png" alt="" /></li>
                            <li><img src="/arrow.png" alt="" /></li>
                        </ol>
                    </div>
                    <div className={styles.topic_text}>
                        ...
                        <div className={styles.SignUp_container}>
                            <ol>
                                ...
                                <li className={styles.SignUpButton}><button>Записаться онлайн</button></li>
                ...
                <div className={styles.Contacts_block_container}>
                    <div className={styles.Contacts_block}>
                        <div className={styles.social_logo_list}>
                            <ul>
                                <li><img src='/maillogo.png' /></li>
                                <li><img src='/tg.png' /></li>
                                <li><img src='/vk.png' /></li>
                                <li><img src="/wapp.png" alt="" /></li>
                            </ul>
                        </div>
                        <div className={styles.block_info}>
                            <div className={styles.telephone_number}>
                                <a href="">
                                    <img src="/tellogo.png" alt="" className={styles.tellogo_body} />
                                    +7-999-999-99-99
                                </a>
                            </div>
                            <ul>
                                ...
                                <li><a href="">whatsApp - +7-999-999-99-99</a></li>
                            </ul>

...
class ServiceController{
    ...
    async deleteAll(req, res) {
        const sql_count = "SELECT COUNT(*) FROM services"; // Подсчитать количество записей в таблице client
        pool.query(sql_count, (err, result) => {
            ...
            const sql_delete = "DELETE FROM services"; // Удалить все записи из таблицы client
    ...
    async deleteOne(req, res) {
        ...
        pool.query(sql_exist, [id], (err, result) => {
            ...
            const sql_delete = `DELETE FROM services WHERE id = $1`;
